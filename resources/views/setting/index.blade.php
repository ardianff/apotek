            ...
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="nama_perusahaan" class="col-lg-2 control-label">Nama Apotek</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="wa" class="col-lg-2 control-label">Nomor WA</label>
                        <div class="col-lg-6">
                            <input type="text" name="wa" class="form-control" id="wa" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
