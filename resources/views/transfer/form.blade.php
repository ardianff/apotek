...
<style>
    ...
    .table-transfer tbody tr:last-child {
        display: none;
    }
...
@section('breadcrumb')
    @parent
    <li class="active">Transaksi transfer</li>
@endsection
                ...
                <form class="form-produk">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="faktur">nomer faktur</label>
                            ...
                            <input id="faktur" class="form-control" type="number" name="no_faktur">
                        </div>
                    </div>
                    <div class="form-group row">
...
<script>
    ...
    function loadForm(diskon = 0) {
        ...
        $.get(`{{ url('/transfer_detail/loadform') }}/${diskon}/${$('.total').text()}`)
            .done(response => {
