        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="text-danger"> Daftar new Member 
                    ...
                    <button onclick="addMember('{{ route('member.store') }}')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah Member Baru</button>
                </h5>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-primary btn-xs btn-flat"
                                        onclick="pilihMember('{{ $item->id}}','{{$item->nama}}')">
