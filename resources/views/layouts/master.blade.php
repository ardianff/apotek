...
<body onload="notaKecil('{{ route('transaksi.nota_kecil') }}', 'Nota Kecil')"  class="hold-transition skin-blue sidebar-mini">
@endif
...
<body onload="print_tutup('{{ route('tutup_kasir.nota_kecil',$kasir->id) }}', 'Laporan Tutup Kasir')"  class="hold-transition skin-blue sidebar-mini">
@endif
