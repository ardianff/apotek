<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        @endphp --}}
        <span class="logo-mini"><img src="{{ url('/img/logo-20220626234159.png') }}" class="image-circle" alt="User Image">Apotek Peduli Semarang</span>
        <!-- logo for regular state and mobile devices -->
         <span class="logo-lg"> <img src="{{ url('/img/logo-20220626234159.png') }}" class="image-circle" alt="User Image">Apotek Peduli Semarang</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
        <!-- Sidebar toggle button-->
        <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
            <span class=""><b>Apotek Peduli Semarang</b></span>
        </a>
